...
public class SwerveOdometry extends InputVector {
    ...
    private final List<String> fModulePositionInputs;
    ...
    public SwerveOdometry(Object name, Config config, InputValues inputValues) {
        ...
        fModulePositionInputs = Lists.of(config.getString("front_right_position"), config.getString("front_left_position"),
    ...
    public double getModuleSpeed(int module) {
        return fSharedInputValues.getNumeric(fModulePositionInputs.get(module));
    }
